...
1. Explain what a token is used for.
   ...
   A token is how the web browser knows who is visting a site and whether to give that user permission to enter or not.

2. What steps can you take in your web apps to keep your data secure?

3) Describe how web servers work.

   A machine hosts data and a web page searches for and accesses that data then downloads it for the user to interact with.
